...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>gw', require('custom.worktree_picker').open, { desc = '[G]it [W]orktrees and branches' })
...

  {
    ...
    config = function()
      vim.keymap.set('n', '<leader>m', ':Neotree<CR>', { desc = 'Open tree view' })
    end,
  },
